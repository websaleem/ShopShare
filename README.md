...
**AWS** *(production)* — static frontend on S3+CloudFront under `shopshare.websaleem.com`, plus a Lambda API. Cost: ~$0–1/month at portfolio traffic. See [`aws/DEPLOY.md`](aws/DEPLOY.md).
...
Once deployed, open `https://shopshare.websaleem.com/`.
